...
public class TestCase14 extends IOSDriverManager {
	...
	@Description("User can cancel pop Login in Premium Sports Linear Channels")
	@Test(dataProvider = "dataLogin")
	public void TC14(HashMap<String, String> data) throws JSchException, IOException, InterruptedException {

		driver.get("https://www.visionplus.id/");
		 takeScreenshot(driver, "Testcase14", "Step1");
		scroll.smoothScrollToBottom(driver);
		click.ClickSeeAll();
		takeScreenshot(driver, "Testcase14", "Step2");
		scroll.smoothScrollToBottom1(driver);
		Thread.sleep(1000);
		click.ClickPremiumSportsChannel();
		Thread.sleep(1000);
		takeScreenshot(driver, "Testcase14", "Step3");
		click.ClickBack();
		Thread.sleep(5000);
		takeScreenshot(driver, "Testcase14", "Step4");
	}
