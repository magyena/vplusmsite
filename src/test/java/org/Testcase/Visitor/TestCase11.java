...
public class TestCase11 extends IOSDriverManager {
	Click click = new Click ();
	IOSDriverManager generated = new IOSDriverManager();
	String Hasil = generated.generateRandomPhoneNumber();
	Scroll scroll = new Scroll();
	@Description("User can cancell pop Login in Premium Linear Channels")
	@Test(dataProvider = "dataLogin")
	public void TC11(HashMap<String, String> data)
